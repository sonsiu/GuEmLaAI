...
import type { FormatOptions } from '@/utils/helper'
...
export interface BaseCardChartProps {
  title: string
  subtitle?: string
  value: number
  prefix?: string
...
export type MonthlyCardStatsProps = {
  title: string
  stats: number
  avatarIcon: string
  avatarSize?: number
...
export type ButtonVariant = 'contained' | 'outlined' | 'text' | 'tonal'
